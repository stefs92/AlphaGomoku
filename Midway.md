...
The main goal for the remainder of the project is to find a way to speed up the self-play, by designing more efficient code and using parallel processing.
